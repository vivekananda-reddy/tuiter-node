...
export default class DislikeController implements DislikeControllerI {
    ...
    public static getInstance = (app: Express): DislikeController => {
        if(DislikeController.dislikeController === null) {
            ...
            app.get("/api/users/:uid/likes", DislikeController.dislikeController.findAllTuitsDislikedByUser);
            app.get("/api/tuits/:tid/likes", DislikeController.dislikeController.findAllUsersThatDislikedTuit);
